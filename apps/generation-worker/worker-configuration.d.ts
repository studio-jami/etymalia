/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a44a4d28304d690d515a7c79d2f57d29)
// Runtime types generated with workerd@1.20260710.1 2026-07-15 
interface __BaseEnv_Env {
	GENERATION_QUEUE: Queue;
	ENVIRONMENT?: "staging" | "production";
	RENDERER_CONTAINER: DurableObjectNamespace<import("./src/index").RendererContainer>;
	FULL_KIT_WORKFLOW: Workflow<Parameters<import("./src/index").FullKitWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RendererContainer";
	}
